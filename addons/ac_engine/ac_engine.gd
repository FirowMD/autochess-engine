...
func _enter_tree():
	add_custom_type("AcCombatCollection", "AcShowHide", preload("res://addons/ac_engine/scripts/combat_collection.gd"), preload("res://addons/ac_engine/images/icon_ctrl.png"))
	...
	add_custom_type("AcCombatShop","AcShowHide",preload("res://addons/ac_engine/scripts/combat_shop.gd"),preload("res://addons/ac_engine/images/icon_ctrl.png"))
