...
func _enter_tree():
	add_custom_type("AcCombatCollection", "AcShowHide", preload("res://addons/ac_engine/scripts/combat_collection.gd"), preload("res://addons/ac_engine/images/icon_show_hide.png"))
	...
	add_custom_type("AcCraftGraph", "Node", preload("res://addons/ac_engine/scripts/craft_graph.gd"), preload("res://addons/ac_engine/images/icon.png"))
	add_custom_type("AcCraftSystem", "Node", preload("res://addons/ac_engine/scripts/craft_system.gd"), preload("res://addons/ac_engine/images/icon_craft_system.png"))
	...
	add_custom_type("AcGameTimer","Node",preload("res://addons/ac_engine/scripts/game_timer.gd"),preload("res://addons/ac_engine/images/icon_timer.png"))
	...
	add_custom_type("AcShowHide","Node",preload("res://addons/ac_engine/scripts/show_hide.gd"),preload("res://addons/ac_engine/images/icon_show_hide.png"))
...
func _exit_tree():
	...
	remove_custom_type("AcCraftGraph")
	remove_custom_type("AcCraftSystem")
