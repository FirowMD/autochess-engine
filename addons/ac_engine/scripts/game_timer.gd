...
func setup_counting_up():
	timer.connect("timeout", update_time)
	timer.start()


func get_pretty_time_string():
...
func get_pretty_time_string_minutes():
...
func add_alarm_event(obj: Object, foo: Callable, wait_time: int, args: Array = []):
